...
| Constructors | |
| :--- | :--- |
| [PortMapInfo\(Protocol, IPEndPoint, int, NatProtocol\)](PortMapInfo(Protocol,IPEndPoint,int,NatProtocol).md 'Pmmux\.Abstractions\.PortMapInfo\.PortMapInfo\(Mono\.Nat\.Protocol, System\.Net\.IPEndPoint, int, Mono\.Nat\.NatProtocol\)') | Represents information about a NAT port mapping between a public endpoint and a local port\. |
