...
## PortMapInfo\(Protocol, IPEndPoint, int, NatProtocol\) Constructor

Represents information about a NAT port mapping between a public endpoint and a local port\.

```csharp
public PortMapInfo(Mono.Nat.Protocol NetworkProtocol, System.Net.IPEndPoint PublicEndpoint, int LocalPort, Mono.Nat.NatProtocol NatProtocol);
```
#### Parameters

<a name='Pmmux.Abstractions.PortMapInfo.PortMapInfo(Mono.Nat.Protocol,System.Net.IPEndPoint,int,Mono.Nat.NatProtocol).NetworkProtocol'></a>
...
<a name='Pmmux.Abstractions.PortMapInfo.PortMapInfo(Mono.Nat.Protocol,System.Net.IPEndPoint,int,Mono.Nat.NatProtocol).PublicEndpoint'></a>
...
<a name='Pmmux.Abstractions.PortMapInfo.PortMapInfo(Mono.Nat.Protocol,System.Net.IPEndPoint,int,Mono.Nat.NatProtocol).LocalPort'></a>
...
<a name='Pmmux.Abstractions.PortMapInfo.PortMapInfo(Mono.Nat.Protocol,System.Net.IPEndPoint,int,Mono.Nat.NatProtocol).NatProtocol'></a>
