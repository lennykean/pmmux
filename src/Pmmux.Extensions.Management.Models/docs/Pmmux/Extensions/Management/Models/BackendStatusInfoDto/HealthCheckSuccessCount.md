...
### [Pmmux\.Extensions\.Management\.Models](../index.md 'Pmmux\.Extensions\.Management\.Models').[BackendStatusInfoDto](index.md 'Pmmux\.Extensions\.Management\.Models\.BackendStatusInfoDto')

## BackendStatusInfoDto\.HealthCheckSuccessCount Property

The number of consecutive health check successes\.

```csharp
public System.Nullable<long> HealthCheckSuccessCount { get; set; }
```
