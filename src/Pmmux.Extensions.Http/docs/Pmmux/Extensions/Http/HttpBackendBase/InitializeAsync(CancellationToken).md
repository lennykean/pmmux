...
## HttpBackendBase\.InitializeAsync\(CancellationToken\) Method
...
<a name='Pmmux.Extensions.Http.HttpBackendBase.InitializeAsync(System.Threading.CancellationToken).cancellationToken'></a>
