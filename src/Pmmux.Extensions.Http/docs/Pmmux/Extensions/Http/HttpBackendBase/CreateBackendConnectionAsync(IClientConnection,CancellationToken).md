...
## HttpBackendBase\.CreateBackendConnectionAsync\(IClientConnection, CancellationToken\) Method
...
<a name='Pmmux.Extensions.Http.HttpBackendBase.CreateBackendConnectionAsync(Pmmux.Abstractions.IClientConnection,System.Threading.CancellationToken).client'></a>
...
<a name='Pmmux.Extensions.Http.HttpBackendBase.CreateBackendConnectionAsync(Pmmux.Abstractions.IClientConnection,System.Threading.CancellationToken).cancellationToken'></a>
